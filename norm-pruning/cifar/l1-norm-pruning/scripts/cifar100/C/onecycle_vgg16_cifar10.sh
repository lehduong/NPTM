...
--use_onecycle \
--lr 0.1 \
--wandb_name vgg_16_B_onecycle_40epochs &&
...
--epochs 56 \
--lr 0.1 \
--wandb_name vgg_16_B_onecycle_56epochs
...
--epochs 72 \
--lr 0.1 \
--wandb_name vgg_16_B_onecycle_72epochs &&
...
--epochs 88 \
--lr 0.1 \
--wandb_name vgg_16_B_onecycle_88epochs &&
...
--epochs 104 \
--lr 0.1 \
--wandb_name vgg_16_B_onecycle_104epochs &&
...
--epochs 120 \
--lr 0.1 \
--wandb_name vgg_16_B_onecycle_120epochs &&
...
--epochs 136 \
--lr 0.1 \
--wandb_name vgg_16_B_onecycle_136epochs &&
...
--epochs 152 \
--lr 0.1 \
--wandb_name vgg_16_B_onecycle_152epochs