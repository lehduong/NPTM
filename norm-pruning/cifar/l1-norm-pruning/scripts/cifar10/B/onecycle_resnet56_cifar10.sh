...
--use_onecycle \
--lr 0.1 \
--wandb_name resnet_56_B_onecycle_40epochs &&
...
--use_onecycle \
--lr 0.1 \
--wandb_name resnet_56_B_onecycle_56epochs &&
...
--use_onecycle \
--lr 0.1 \
--wandb_name resnet_56_B_onecycle_72epochs &&
...
--use_onecycle \
--lr 0.1 \
--wandb_name resnet_56_B_onecycle_88epochs &&
...
--use_onecycle \
--lr 0.1 \
--wandb_name resnet_56_B_onecycle_104epochs &&
...
--use_onecycle \
--lr 0.1 \
--wandb_name resnet_56_B_onecycle_120epochs &&
...
--use_onecycle \
--lr 0.1 \
--wandb_name resnet_56_B_onecycle_136epochs &&
...
--use_onecycle \
--lr 0.1 \
--wandb_name resnet_56_B_onecycle_152epochs