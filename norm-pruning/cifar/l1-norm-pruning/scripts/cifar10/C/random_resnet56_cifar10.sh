...
--use_random \
--lr 0.1 \
--wandb_name resnet_56_C_random_40epochs &&
...
--use_random \
--lr 0.1 \
--wandb_name resnet_56_C_random_56epochs &&
...
--use_random \
--lr 0.1 \
--wandb_name resnet_56_C_random_72epochs &&
...
--use_random \
--lr 0.1 \
--wandb_name resnet_56_C_random_88epochs &&
...
--use_random \
--lr 0.1 \
--wandb_name resnet_56_C_random_104epochs &&
...
--use_random \
--lr 0.1 \
--wandb_name resnet_56_C_random_120epochs &&
...
--use_random \
--lr 0.1 \
--wandb_name resnet_56_C_random_136epochs &&
...
--use_random \
--lr 0.1 \
--wandb_name resnet_56_C_random_152epochs