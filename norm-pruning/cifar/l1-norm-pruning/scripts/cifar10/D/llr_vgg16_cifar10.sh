...
--use_llr \
--lr 0.1 \
--wandb_name vgg_16_C_llr_40epochs &&
...
--epochs 56 \
--lr 0.1 \
--wandb_name vgg_16_C_llr_56epochs
...
--epochs 72 \
--lr 0.1 \
--wandb_name vgg_16_C_llr_72epochs &&
...
--epochs 88 \
--lr 0.1 \
--wandb_name vgg_16_C_llr_88epochs &&
...
--epochs 104 \
--lr 0.1 \
--wandb_name vgg_16_C_llr_104epochs &&
...
--epochs 120 \
--lr 0.1 \
--wandb_name vgg_16_C_llr_120epochs &&
...
--epochs 136 \
--lr 0.1 \
--wandb_name vgg_16_C_llr_136epochs &&
...
--epochs 152 \
--lr 0.1 \
--wandb_name vgg_16_C_llr_152epochs