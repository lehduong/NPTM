...
--init_lr 0.001 \
--lr 0.1 \
--wandb_name resnet_110_D_llr_40epochs &&
...
--init_lr 0.001 \
--lr 0.1 \
--wandb_name resnet_110_D_llr_56epochs &&
...
--init_lr 0.001 \
--lr 0.1 \
--wandb_name resnet_110_D_llr_72epochs &&
...
--init_lr 0.001 \
--lr 0.1 \
--wandb_name resnet_110_D_llr_88epochs &&
...
--init_lr 0.001 \
--lr 0.1 \
--wandb_name resnet_110_D_llr_104epochs &&
...
--init_lr 0.001 \
--lr 0.1 \
--wandb_name resnet_110_D_llr_120epochs &&
...
--init_lr 0.001 \
--lr 0.1 \
--wandb_name resnet_110_D_llr_136epochs &&
...
--init_lr 0.001 \
--lr 0.1 \
--wandb_name resnet_110_D_llr_152epochs