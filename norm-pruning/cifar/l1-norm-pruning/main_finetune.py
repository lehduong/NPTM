...
if args.use_llr:
    args.num_warmup = int(args.pct_start*args.epochs)
...
for epoch in range(args.start_epoch, args.epochs):
    ...
    wandb.log({'top1': prec1, 'best_acc': best_prec1,
               'lr': cur_lr, 'avg_train_loss': avg_train_loss, 'avg_test_loss': avg_test_loss})
