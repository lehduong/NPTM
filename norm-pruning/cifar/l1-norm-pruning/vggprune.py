...
acc = test(model)
if args.v == 'A':
    cfg = [32, 64, 'M', 128, 128, 'M', 256, 256,
           256, 'M', 256, 256, 256, 'M', 256, 256, 256]
elif args.v == 'B':
    cfg = [32, 64, 'M', 128, 128, 'M', 196, 196,
           196, 'M', 196, 196, 256, 'M', 256, 256, 256]
elif args.v == 'C':
    cfg = [32, 64, 'M', 64, 128, 'M', 128, 128,
           128, 'M', 196, 196, 196, 'M', 196, 196, 196]
else:
    raise ValueError("Expected pruning version to be either A, B or C")
