initial_prune(){python cifar_prune.py \
    ...
    --save_dir ../../../result/norm_pruning/weights/$1$2/random/prune_$4
}
...
later_prune(){
    ...
    --random_rank \
    --percent $3 \
    --resume ../../../result/norm_pruning/weights/$1$2/random/prune_$previous/finetuned.pth.tar \
    --save_dir ../../../result/norm_pruning/weights/$1$2/random/prune_$4
}
...
finetune(){
    ...
    --depth $2 \
    --dataset cifar10 \
    --resume ../../../result/norm_pruning/weights/$1$2/random/prune_$4/pruned.pth.tar \
    --save_dir ../../../result/norm_pruning/weights/$1$2/random/prune_$4 \
    --lr 0.1 \
    --use_onecycle \
    --wandb_name iterative_preresnet_110_$3_random
}
