...
resnet110(){
    ...
    retrain resnet 110 0.1 40 0.2
    prune resnet 110 0.3
    retrain resnet 110 0.1 40 0.3
    prune resnet 110 0.4
    retrain resnet 110 0.1 40 0.4
    prune resnet 110 0.5
    retrain resnet 110 0.1 40 0.5
    prune resnet 110 0.6
    retrain resnet 110 0.1 40 0.6
    prune resnet 110 0.7
    retrain resnet 110 0.1 40 0.7
    prune resnet 110 0.8
    retrain resnet 110 0.1 40 0.8
    prune resnet 110 0.9
    retrain resnet 110 0.1 40 0.9
    prune resnet 110 0.95
    retrain resnet 110 0.1 40 0.95
}

random_resnet110(){
    random_prune resnet 110 0.2
    random_retrain resnet 110 0.1 40 0.2
    random_prune resnet 110 0.3
    random_retrain resnet 110 0.1 40 0.3
    random_prune resnet 110 0.4
    random_retrain resnet 110 0.1 40 0.4
    random_prune resnet 110 0.5
    random_retrain resnet 110 0.1 40 0.5
    random_prune resnet 110 0.6
    random_retrain resnet 110 0.1 40 0.6
    random_prune resnet 110 0.7
    random_retrain resnet 110 0.1 40 0.7
    random_prune resnet 110 0.8
    random_retrain resnet 110 0.1 40 0.8
    random_prune resnet 110 0.9
    random_retrain resnet 110 0.1 40 0.9
    random_prune resnet 110 0.95
    random_retrain resnet 110 0.1 40 0.95
}
