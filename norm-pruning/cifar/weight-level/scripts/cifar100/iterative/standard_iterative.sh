initial_prune(){python cifar_prune.py \
    ...
    --save_dir ../../../result/norm_pruning/weights/$1$2/standard/prune_$4
}
...
later_prune(){
    ...
    --dataset cifar100 \
    --percent $3 \
    --resume ../../../result/norm_pruning/weights/$1$2/standard/prune_$previous/finetuned.pth.tar \
    --save_dir ../../../result/norm_pruning/weights/$1$2/standard/prune_$4
}
...
finetune(){
    ...
    --depth $2 \
    --dataset cifar100 \
    --resume ../../../result/norm_pruning/weights/$1$2/standard/prune_$4/pruned.pth.tar \
    --save_dir ../../../result/norm_pruning/weights/$1$2/standard/prune_$4 \
    --wandb_name iterative_preresnet_110_$3_standard
}
